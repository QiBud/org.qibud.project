...
(function(_root){
    ...
    _root.budRole = function( identity, pack, role, callback ) {
        var url = jsRoutes.controllers.Buds.budRole( identity, pack, role ).url;
    ...
    _root.saveBudRole = function( identity, pack, role, data ) {
        var url = jsRoutes.controllers.Buds.saveBudRole( identity, pack, role ).url;
    ...
    _root.invokeBudRoleAction = function( identity ,pack, role, action, data ) {
        var url = jsRoutes.controllers.Buds.invokeBudRoleAction( identity, pack, role, action ).url;
